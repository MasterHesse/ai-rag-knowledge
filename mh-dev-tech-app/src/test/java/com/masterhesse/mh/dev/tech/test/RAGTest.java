...
public class RAGTest {
    ...
    public void upload(){
        ...
        documents.forEach(doc -> doc.getMetadata().put("knowledge", "Base-Hesse"));
        documentSplitterList.forEach(doc -> doc.getMetadata().put("knowledge", "Base-Hesse"));
    ...
    public void chat(){
        ...
        String SYSTEM_PROMPT = """
         ...
         SearchRequest searchRequest = SearchRequest.query(message).withTopK(5).withFilterExpression("knowledge == 'Base-Hesse'");
